...
const MyProfile = () => {
  ...
  const [userData,setUserData] = useState({
    ...
    email: 'kushaltyagi2001@gmail.com',
    phone: '+91 8795865441',
    address: {
      line1:'501,5th Floor , Avinya Heights',
      line2: 'sector 31, Noida, India'
    },
    gender: 'Male',
    dob: '2000-01-20'
  })
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          <p className='font-medium'>Address:</p>
          {
            ...
            ? <p>
              ...
              <input 
              className='bg-gray-50'
              onChange={(e) => setUserData(prev => ({...prev,address,line2: e.target.value}))} value={userData.address.line2} type="text"/>
            </p>
